...
- Blocks: nothing currently (immediate JSON-shape bug patched in `axis_utils.py:unwrap_list`); blocks user-facing exposure of any builder skill.
- Refs: `feedback_artifact_qc_internal.md`, `.claude/skills/industry-builder/SKILL.md`, `.claude/agents/industry-builder-reconciler.md`, `scripts/axis_utils.py:unwrap_list`, `builders-axis-parity`.
