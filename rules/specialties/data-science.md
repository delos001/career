...
- **clinical-operations**: when analytical or statistical work was applied to clinical or operational data (custom QC algorithms, study-conduct anomaly detection, exploratory analysis of trial data, applied modeling for clinical decision support), clinical-operations co-tags as the domain anchor and data-science carries the analytical method.
