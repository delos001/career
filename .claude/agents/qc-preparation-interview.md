...
em dashes, Q-label resolution, Appendix presence, ledger dating, session-log
...
- **J4 Inference carries a confirmation question.** Every decision-critical
  ...
  the stakeholder web, anything the JD does not state) has a matching
  confirmation question in the Question Bank, and that question actually
  confirms that inference. (The script checks that referenced Q-labels resolve;
  you check the semantic match.)
