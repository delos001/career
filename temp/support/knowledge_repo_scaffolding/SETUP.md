...
This file originates in the framework repo at `support/knowledge_repo_scaffolding/SETUP.md`. When you set up your own career data repo, copy this file (along with `README.md`, `.gitignore`, and `User_Info.md` from the same scaffolding folder) into `personal/knowledge/` in your cloned repo.
...
- `User_Info.md` — single source of truth for CV contact line values
...
2. From the framework repo root, clone the repo into `personal/`:
   ...
   ```
3. Create a `knowledge/` subdirectory inside the cloned repo and copy the contents of `support/knowledge_repo_scaffolding/` into it. This gives you a starting `README.md`, `SETUP.md`, `.gitignore`, and `User_Info.md` skeleton.
...
7. Fill in `User_Info.md` with your personal contact details.
