...
| `User_Info.md` | Single source of truth for CV contact line values (name, email, phone, LinkedIn, GitHub, optional website). | cv_targeted Phase 3a; cv_general Phase 5a |
